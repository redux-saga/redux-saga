...
export function take<A extends Action>(pattern?: ActionPattern<A>): SagaGenerator<A, TakeEffect>
 ...
 */
export function takeMaybe(pattern?: ActionPattern): SagaGenerator<any, TakeEffect>
export function takeMaybe<A extends Action>(pattern?: ActionPattern<A>): SagaGenerator<A, TakeEffect>
 ...
 */
export function take<T>(channel: TakeableChannel<T>, multicastPattern?: Pattern<T>): SagaGenerator<T, ChannelTakeEffect<T>>
 ...
 * object.
 */
export function takeMaybe<T>(channel: TakeableChannel<T>, multicastPattern?: Pattern<T>): SagaGenerator<T, ChannelTakeEffect<T>>
 ...
 */
export function put<A extends Action>(action: A): SagaGenerator<A, PutEffect<A>>
 ...
 * @param action [see Redux `dispatch` documentation for complete info](https://redux.js.org/api/store#dispatchaction)
 */
export function putResolve<A extends Action>(action: A): SagaGenerator<A, PutEffect<A>>
 ...
 * @param action [see Redux `dispatch` documentation for complete info](https://redux.js.org/api/store#dispatchaction)
 */
export function put<T>(channel: PuttableChannel<T>, action: T | END): SagaGenerator<T, ChannelPutEffect<T>>
 ...
 */
export function cps<Fn extends (cb: CpsCallback<any>) => any>(fn: Fn): SagaGenerator<ReturnType<Fn>, CpsEffect<ReturnType<Fn>>>
...
export function fork<Fn extends (...args: any[]) => any>(
  fn: Fn,
  ...args: Parameters<Fn>,
): SagaGenerator<Task<SagaReturnType<Fn>>, ForkEffect<SagaReturnType<Fn>>>
/**
...
export function fork<Ctx extends { [P in Name]: (this: Ctx, ...args: any[]) => any }, Name extends string>(
  ctxAndFnName: [Ctx, Name],
  ...args: Parameters<Ctx[Name]>
): SagaGenerator<Task<SagaReturnType<Ctx[Name]>>, ForkEffect<SagaReturnType<Ctx[Name]>>>
/**
 ...
 */
export function actionChannel(pattern: ActionPattern, buffer?: Buffer<Action>): SagaGenerator<Channel<ActionPattern>, ActionChannelEffect>
 ...
 * @param channel a `Channel` Object.
 */
export function flush<T>(channel: FlushableChannel<T>): SagaGenerator<T[], FlushEffect<T>>
 ...
 */
export function setContext<C extends object>(props: C): SagaGenerator<void, SetContextEffect<C>>

/**
 * Creates an effect that instructs the middleware to return a specific property
 * of saga's context.
 */
export function getContext<T = unknown>(prop: string): SagaGenerator<T, GetContextEffect>

/**
 * Returns an effect descriptor to block execution for `ms` milliseconds and return `val` value.
 */
export function delay<T = true>(ms: number, val?: T): SagaGenerator<T, CallEffect<T>>
 ...
 *    }
 */
export function all<T>(effects: T[]): SagaGenerator<EffectReturnType<T>[], AllEffect<T>>
/**
 ...
 */
export function all<T extends { [key: string]: any }>(effects: T): SagaGenerator<{ [K in keyof T]: EffectReturnType<T[K]> }, AllEffect<T[keyof T]>>
 ...
 * @param effects a dictionary Object of the form {label: effect, ...}
 */
export function race<T>(effects: T[]): SagaGenerator<(EffectReturnType<T> | undefined)[], RaceEffect<T>>
/**
 * The same as `race(effects)` but lets you pass in an array of effects.
 */
export function race<T extends { [key: string]: any }>(effects: T): SagaGenerator<{ [K in keyof T]: EffectReturnType<T[K]> | undefined }, RaceEffect<T[keyof T]>>
