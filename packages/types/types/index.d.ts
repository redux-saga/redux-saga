 ...
 */
export type SagaIterator<RT = any> = Generator<StrictEffect, RT, any>
...
export interface CombinatorEffect<T, P> extends Effect<T, CombinatorEffectDescriptor<P>> {
  combinator: true
}
